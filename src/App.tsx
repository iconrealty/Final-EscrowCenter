              ...
              {filteredEscrows.length > 0 ? (
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 xl:gap-8 w-full min-w-0">
                  {filteredEscrows.map((escrow, index) => (
                    <div key={escrow.id} className="w-full sm:w-[calc(87.5%+4.5px)] xl:w-full max-w-full min-w-0">
                      <EscrowCard 
                        escrow={escrow}
                        index={index}
                ...
                <div className="bg-white border border-[#e5e5ea] shadow-[0_2px_8px_rgba(0,0,0,0.04)] rounded-2xl p-12 text-center w-full sm:w-[calc(87.5%+4.5px)] xl:w-full max-w-full min-w-0">
