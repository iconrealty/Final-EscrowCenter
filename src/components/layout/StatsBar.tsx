  ...
  return (
    <div className="bg-[#f5f5f7] px-4 py-3 sm:px-6 sm:py-4 flex items-center justify-start gap-3 sm:gap-4 border-b border-[#e5e5ea] overflow-x-auto scrollbar-none">
      ...
      <div className="h-[72px] sm:h-[84px] bg-white border border-[#e5e5ea] shadow-[0_2px_8px_rgba(0,0,0,0.04)] rounded-2xl px-5 sm:px-6 flex flex-col justify-center shrink-0">
        <div className="text-[9px] uppercase tracking-[0.9px] text-[#334155] font-bold mb-1 truncate">Closed Commission</div>
      ...
      {/* Open Escrows - Square Badge/Tab */}
      <div className="w-[72px] h-[72px] sm:w-[84px] sm:h-[84px] bg-white border border-[#e5e5ea] shadow-[0_2px_8px_rgba(0,0,0,0.04)] rounded-2xl flex flex-col items-center justify-center shrink-0">
        <div className="text-[9px] uppercase tracking-[0.5px] text-[#334155] font-bold text-center leading-none">Open</div>
        <div className="text-xl sm:text-2xl font-bold font-mono text-[#FF7518] mt-2 leading-none">{openCount}</div>
      </div>

      {/* Closed YTD - Square Badge/Tab */}
      <div className="w-[72px] h-[72px] sm:w-[84px] sm:h-[84px] bg-white border border-[#e5e5ea] shadow-[0_2px_8px_rgba(0,0,0,0.04)] rounded-2xl flex flex-col items-center justify-center shrink-0">
        <div className="text-[9px] uppercase tracking-[0.5px] text-[#334155] font-bold text-center leading-none">Closed YTD</div>
